<?php
include_once '../Controller/CtlAgInfo2.php';
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <script type="text/javascript" src="../bootstrap/js/jsAgentForm2.js"></script>
        <div class="container">
            <div class="row">
                <br>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-11 col-lg-offset-1">
                        <div class="form-group">
                            <div class="col-md-2">
				<input type="hidden" value="<?php echo $lAgent ?>" id="agg" name="agg">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="apell" id="apell" class="form-control input-sm" placeholder="Apellido">
                            </div>
                            <div class="col-md-2">
                                <label for="cuit">Dni</label>
                                <input type="text" name="dni" id="dni" class="form-control input-sm" placeholder="D.N.I.">
                            </div>
                            <div class="col-md-3">
                                <label for="cuit">Direccion</label>
                                <input type="text" name="direc" id="direc" class="form-control input-sm" placeholder="direccion" id="address1">
                            </div>
                            <div class="col-md-2">
                                <br>
                    ...
                    <div class="col-lg-11 col-lg-offset-1">
                        <div class="form-group">
                            <div class="col-md-1">
                                ...
                                <input type="text" name="codpostal" id="codpostal" class="form-control input-sm" placeholder="cp">
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" id="telalt" name="telalt" class="form-control input-sm" placeholder="tel. alternativo">
                            </div>
                            <div class="col-md-3">
                                <label for="cuit">E-mail</label>
                                <input type="text" id="email" name="email" class="form-control input-sm" placeholder="johndoe@gmail.com">
                            </div>
                            <div class="col-md-2">
                                <label for="cuit">Fecha de Nacimiento</label>
                                <input type="text" name="fechanac" class="form-control input-sm" placeholder="Ej. 10/04/2001" id="fechanac">
                            </div>
                            <div class="col-lg-1">
                                <br>
